...
function MovieCard({ imgSrc, title, rating, genres, overview, date, id, trailer, updateFavorites, updateWatchlist }) {
    ...
    const likeHandler = (e) => {
        e.stopPropagation();
        const newFill = likeFill === "#c0c0c0" ? "#ff6961" : "#c0c0c0";
        setLikeFill(newFill);
        updateFavorites({ id, title }, newFill === "#ff6961");
    }

    const watchHandler = (e) => {
        e.stopPropagation();
        const newFill = watchFill === "#c0c0c0" ? "#b4d3b2" : "#c0c0c0";
        setWatchFill(newFill);
        updateWatchlist({ id, title }, newFill === "#b4d3b2");
    }
